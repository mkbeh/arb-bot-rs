...
/// 1. In the exact output case, token 0 supply decreases leading to price increase. Move price up
///    so that exact output is met.
/// 2. In the exact input case, token 0 supply increases leading to price decrease. Do not round
...
/// 1. In the exact output case, token 1 supply decreases leading to price decrease. Move price down
///    by rounding down so that exact output of token 0 is met.
/// 2. In the exact input case, token 1 supply increases leading to price increase. Do not round
///    down to minimize price impact. We only need to meet input change and not gurantee exact
///    output for token 0.
///
/// # Formula
///
