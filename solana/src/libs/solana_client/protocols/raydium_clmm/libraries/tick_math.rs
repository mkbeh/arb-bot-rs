...
use crate::libs::solana_client::protocols::raydium_clmm::ErrorCode;
...
/// The minimum value that can be returned from #get_sqrt_price_at_tick. Equivalent to
/// get_sqrt_price_at_tick(MIN_TICK)
pub const MIN_SQRT_PRICE_X64: u128 = 4295048016;
/// The maximum value that can be returned from #get_sqrt_price_at_tick. Equivalent to
...
/// # Arguments
/// * `tick` - Price tick
pub fn get_sqrt_price_at_tick(tick: i32) -> anyhow::Result<u128> {
    let abs_tick = tick.unsigned_abs();
    anyhow::ensure!(abs_tick <= MAX_TICK as u32, ErrorCode::TickUpperOverflow);
...
pub fn get_tick_at_sqrt_price(sqrt_price_x64: u128) -> anyhow::Result<i32> {
