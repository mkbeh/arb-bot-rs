...
use crate::libs::solana_client::{
    models::*,
    pool::*,
    protocols::orca::{constants::*, math::floor_division, token::get_epoch_transfer_fee},
...
impl ProtocolIdentity for Whirlpool {
...
impl ProtocolIdentity for OrcaTickArray {
    fn protocol(&self) -> ProtocolKind {
        ProtocolKind::Orca
    }
}
...
impl ProtocolIdentity for FixedTickArray {
    fn protocol(&self) -> ProtocolKind {
        ProtocolKind::Orca
    }
}
...
impl FixedTickArray {
    pub const POOL_ID_OFFSET: usize = 9956;
...
impl ProtocolIdentity for DynamicTickArray {
    fn protocol(&self) -> ProtocolKind {
        ProtocolKind::Orca
    }
}
...
impl DynamicTickArray {
    ...
    pub const POOL_ID_OFFSET: usize = 12;
